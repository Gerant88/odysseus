...
async def _run_project_proposal(
    ...
    proposal_system = (
        ...
        "Given a project idea, produce a structured proposal document in Markdown.\n\n"
        "The document must include ALL of these sections in order:\n\n"
        "# <title>\n\n"
        "## Summary\n"
        "One paragraph describing the goal and who it is for.\n\n"
        "## Market Research\n"
        "What does the market look like? Is there demand? "
        "What trends support or work against this idea? "
        "Reference real patterns or data points where possible.\n\n"
        "## Competitors & Alternatives\n"
        "List 3-5 existing products or alternatives. For each: name, what they do, "
        "their strengths, their weaknesses, and how this idea differs.\n\n"
        "## Architecture\n"
        ...
        "Be direct and candid. Is this worth pursuing? "
        "What are the biggest risks? What would need to be true for this to succeed? "
        "Give a clear verdict: Go / Pause / Stop — with reasoning.\n\n"
        "Be specific. Avoid filler. Aim for 600-1000 words. "
